...
- Solution URL: [Add solution URL here](https://github.com/JakeHand/nft-preview-card-component)
- Live Site URL: [Add live site URL here](https://jakehand.github.io/nft-preview-card-component/)
